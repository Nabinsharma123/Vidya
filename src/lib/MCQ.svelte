...
<div
    class="block select-none m-3  max-w-[600px]  py-5 px-7 bg-white border border-gray-200 rounded-lg shadow-2xl  dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700"
>
    <h5
